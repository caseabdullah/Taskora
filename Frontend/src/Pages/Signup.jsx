    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
      ...
      <div className="absolute inset-0 rounded-3xl z-50 flex items-center justify-center  bg-black/30 backdrop-blur-sm">
        ...
        <div className="flex justify-between items-center flex-row">
          <h1 className="top text-3xl font-bold text-white">Create your Account</h1>
          <div
            onClick={()=>{
            navigate("/")
            }}
        ...
        className="mt-5 flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            ...
            ref={usernameRef}
              ...
              className="border-2 caret-white text-white placeholder:text-gray-400 bg-[#1A1A1A] border-[#2D2D2D]  rounded-xl px-4 py-3 outline-none focus:border-[#E0FF22] transition-colors duration-300"
            />
          </div>
          ...
          <div className="relative flex flex-col gap-2">
            ...
            className="absolute cursor-pointer text-[#E0FF22] right-3 bottom-[3%] -translate-y-1/2"
            >
        ...
        <p className="text-gray-400 mt-4">
          ...
          <Link to="/login" className="pl-1.5 text-[#E0FF22] underline cursor-pointer hover:underline">
            Log in
          </Link>
        </p>
      </div>
